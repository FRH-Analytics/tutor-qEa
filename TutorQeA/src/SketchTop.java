...
public class SketchTop extends EmbeddedSketch {
	...
	public SketchTop(int width, int height) {
		...
		SKETCH_1 = new SubSketch1(this, 0, 60, 340, myHeight - 110);
		SKETCH_2 = new SubSketch2(this, 340, 60, myWidth - 350, myHeight - 110);
	}
	...
	public void mousePressed() {
		...
		if (MainTutorQeA.SKETCH_TOP.SKETCH_2.getClickedClusterId() != -1
				&& isMouseOverFeature()) {
	...
	private void changeQuestionOrdering() {
		...
		MainTutorQeA.SKETCH_BOTTOM
				.updateQuestionsByCluster(MainTutorQeA.SKETCH_TOP.SKETCH_2
						.getClickedClusterId());
	}

	private boolean isMouseOverFeature() {
		String featureName = QuestionData.getFeatureNameOfSortIndex();
		float featureCenterX = (MainTutorQeA.SKETCH_BOTTOM.getqFeatureX1() + MainTutorQeA.SKETCH_BOTTOM
				.getqFeatureX2()) / 2;
	...
	public void controlEvent(ControlEvent theEvent) {
		...
		MainTutorQeA.SKETCH_BOTTOM.removeQuestionsAndCluster();
		SKETCH_2.updatePlot();
	}
	...
	private void drawMiddleHeader() {
		...
		int clusterId = MainTutorQeA.SKETCH_BOTTOM.getChosenClusterId();
		...
		featureCenterX = (MainTutorQeA.SKETCH_BOTTOM.getqFeatureX2() + MainTutorQeA.SKETCH_BOTTOM
				.getqFeatureX1()) / 2;
		questionCenterX = (MainTutorQeA.SKETCH_BOTTOM.getqTitleX2() + MainTutorQeA.SKETCH_BOTTOM
				.getqTitleX1()) / 2;
		answersCenterX = (MainTutorQeA.SKETCH_BOTTOM.getqAnswerX2() + MainTutorQeA.SKETCH_BOTTOM
				.getqAnswerX1()) / 2;
	...
	private void drawTooltipFeatureChange() {
		...
		rect(tooltipX, tooltipY, textWidth(tooltip) * (float) 1.2, 40, 5, 5);
